from abusehelper.bots.experts import observerexpert
...
class ObserverExpert(observerexpert.ObserverExpert):

    def __init__(self, *args, **keys):
        observerexpert.ObserverExpert.__init__(self, *args, **keys)
