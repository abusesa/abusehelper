...
from abusehelper.bots.experts import expertsanitizer


class ExpertSanitizer(expertsanitizer.ExpertSanitizer):
    
    def __init__(self, *args, **keys):
    	expertsanitizer.ExpertSanitizer.__init__(self, *args, **keys)
