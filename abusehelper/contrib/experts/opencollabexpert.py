from abusehelper.bots.experts import opencollabexpert
...
class OpenCollabExpert(opencollabexpert.OpenCollabExpert):
    
    def __init__(self, *args, **keys):
        opencollabexpert.OpenCollabExpert.__init__(self, *args, **keys)
