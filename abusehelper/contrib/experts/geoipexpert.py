...
from abusehelper.bots.experts import geoipexpert 
from abusehelper.bots.experts.geoipexpert import *


class GeoIPExpert(geoipexpert.GeoIPExpert):

    def __init__(self, *args, **keys):
        geoipexpert.GeoIPExpert.__init__(self, *args, **keys)
