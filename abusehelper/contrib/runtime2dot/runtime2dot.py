from abusehelper.tools.runtime2dot import runtime2dot

"""
Important notice:

This module is deprecated and will not be maintained. Maintained
version exists now under abusehelper.tools package.
...
class DotBot(runtime2dot.DotBot):
    ...
    def __init__(self, *args, **keys):
        ...
        self.log.error("This bot is deprecated. It will move under abusehelper.tools package after 2016-01-01. Please update your references to the bot.")
