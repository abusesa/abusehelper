from abusehelper.bots.opencollab import opencollabreader
...
class OpenCollabReader(opencollabreader.OpenCollabReader):
    
    def __init__(self, *args, **keys):
        opencollabreader.OpenCollabReader.__init__(self, *args, **keys)
