from abusehelper.bots import abusech
...
class AbuseCHFeedBot(abusech.AbuseCHFeedBot):
    
    def __init__(self, *args, **keys):
        abusech.AbuseCHFeedBot.__init__(self, *args, **keys)
...
if __name__ == "__main__":
    AbuseCHFeedBot.from_command_line().execute()
