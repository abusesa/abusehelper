...
from abusehelper.bots.danger import bruteforceblocker


class BruteForceBlockerBot(bruteforceblocker.BruteForceBlockerBot):
    
    def __init__(self, *args, **keys):
        bruteforceblocker.BruteForceBlockerBot.__init__(self, *args, **keys)
